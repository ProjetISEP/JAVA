...
//	public static boolean left=false;
	...
	Vaisseau(double px, double py, double pvx, double pvy, int plife, int pscore,
			int pMatricule, boolean pbouclier, int pStock, boolean pHaut,boolean pBas,boolean pDroite,boolean pGauche,boolean pInertie, double pItop,double pIbottom, double pIright,double pIleft) {// Un vaisseau poss̬de une matricule pour la
	...
	public void toucheInversee(int x1, int x2) {// la fonction de controle des touches a besoin du while true pour etre execut̩ du
		...
		if (this.x >= myrectangle.get(x1).getxter()
			...
			//		System.out.println("pas invers̩e");
		}
		}
	}
