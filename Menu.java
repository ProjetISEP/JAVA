		...
		while(navigation){
			...
			while(multi){
				...
				if(367<StdDraw.mouseX() && 2897>StdDraw.mouseX() && 732<StdDraw.mouseY() && 3856>StdDraw.mouseY()){
					if(StdDraw.mousePressed()){
						nbjoueurs=1;
						multi1=true;
						myVaisseau.add(new Vaisseau(3000, 3000, 0, 0, 10, 0, 0,false,5, false, false,false, false, false,0,0,0,0));
						multi=false;
						navigation=false;
					}
					...
					if(StdDraw.mousePressed()){
						...
						for(int g=0;g<nbjoueurs;g++){
							myVaisseau.add(new Vaisseau(3000, 3000+g*1000, 0, 0, 10, 0, g,false,5, false, false,false, false, false,0,0,0,0));
						}
						multi1=true;
						multi=false;
						multi2joueurs=true;
			...
			while(ai){
				...
				if(380<StdDraw.mouseX() && 3863>StdDraw.mouseX() && 842<StdDraw.mouseY() && 4978>StdDraw.mouseY()){
					if(StdDraw.mousePressed()){
						myVaisseau.add(new Vaisseau(3000, 5000, 0, 0, 10, 0, 0,false,5, false, false,false, false, false,0,0,0,0));
						myVaisseau.add(new AI(6000, 5000, 0, 0, 10, 0, 1,false,false,false,false,false, false, false,5,false, false,false, false, false));
						niveau="Normal";
						ai1=true;
						ai=false;
						navigation=false;
